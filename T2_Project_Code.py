# -*- coding: utf-8 -*-
"""
Created on Fri Mar 20 21:03:19 2020
...
def tempdengue():
    ru=0
    while ru<=runs: #set up number of runs
...
#print("The fraction of the human population that is immune or dead is " + str((X4[days-1]/N)*100) + "%.")
#print("The number of cases is " + str(X2[i]))
#print("The number of infected mosquitos is " + str(Z2[i]))
#print("The number of infectious mosquitos is " + str(Z3[i]))
...
# days = 50
# #-------------------------------------
# #Set up arrays for storing the energy (biomass) amounts
# t=np.zeros(days*1)
# Z1=np.zeros(days*1)
# Z2=np.zeros(days*1)
# Z3=np.zeros(days*1)

# Z1[0] = 900 #susceptible
# Z2[0] = 100 #infected
# Z3[0] = 0 #infectious
# # X4[0] = 0 #removed/recovered
# # X5[0] = 25 # decomposers
...
# # rho40 = 0.32
# # rho50 = 188.6/365
# #rho50 = 188.6/365 #full value causes crash --> error in paramater value?
# #print(rho50)
# infect = 0.7/1 # feeding gain rate / day
# incubate = 0.5/1
# # tau34 = 0.0/1

# for i in range(1,days*1): #This loop for each day
# 	j=i-1
# 	G12 = (infect*Z1[j]*Z2[j])/P #update feeding rates (gain)
# 	G23 = (incubate*Z2[j])
# 	# F34 = (tau34*X3[j])
# 	F10 = zho10*Z1[j] #update respiration loss rates
# 	F20 = zho20*Z2[j]
# 	F30 = zho30*Z3[j]
# 	# F40 = rho40*X4[j]

# 	# calculate derivatives (fluxes)
# 	dZ1 = -G12
# 	dZ2 = G12-G23
# 	dZ3 = G23-G34
# 	# dX4 = F34
...
# #plot the data
# t=t #convert time vector to months
# plt.figure(1) #initialize plot
# plt.title('Spread of Disease in Mosquitos')
# # if  producers:plt.plot(t,X1,'g-',label='Prod') #plot
# plt.plot(t,Z1/P,'r-',label='Susceptible')
# plt.plot(t,Z2/P,'b-',label='Infected')
# plt.plot(t,Z3/P,'c-',label='Infectious')
# # plt.plot(t,X4/N,'k-',label='Recovered')
